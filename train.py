...
def initParameters():
    ...
    parser.add_argument("--crop_size", type=int, default=128, help="size of cropping area from image")
    parser.add_argument("--full_frame_mode", type=bool, default=True, help="enable full frame")
